...
//public class Gravity : MonoBehaviour, IConvertGameObjectToEntity
//{
...
public class GravitySystem : JobComponentSystem
{
    ...
    //[BurstCompile]
    public struct Gravity : IJobForEach<Translation, PlanetsComponents>
    {
        public NativeArray<Translation> traget;
        public void Execute(ref Translation c0, ref PlanetsComponents c1)
        {
            
        }
    }

    public struct TrigerGravity : ITriggerEventsJob
    {
...
public class TriggerGravityFactorSystem : JobComponentSystem
{
    ...
    struct TriggerGravityFactorJob : ITriggerEventsJob
    {
        ...
        public void Execute(TriggerEvent triggerEvent)
        {
            ...
            component.Linear.x *= 2;
            component.Linear.y *= 2;
